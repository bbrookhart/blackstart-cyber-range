# Experiment EXP-SCN004-backstop-enabled-41fa58ff
...
**Seed:** 4242 · **Configuration hash:** `41fa58ffa0754094…`
...
| INV-005 | Effective control setpoint bound | ok | |
...
uv run blackstart evidence verify EXP-SCN004-backstop-enabled-41fa58ff
```
