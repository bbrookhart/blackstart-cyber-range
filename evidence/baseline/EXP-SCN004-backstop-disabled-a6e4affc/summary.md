# Experiment EXP-SCN004-backstop-disabled-a6e4affc
...
**Seed:** 4242 · **Configuration hash:** `a6e4affcea4455bc…`
...
| Violated invariants | INV-001, INV-004 |
...
uv run blackstart evidence verify EXP-SCN004-backstop-disabled-a6e4affc
```
